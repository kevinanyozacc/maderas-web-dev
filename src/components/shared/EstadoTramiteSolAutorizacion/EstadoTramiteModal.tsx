...
import EstadoResponsableInfoModal from './EstadoSolicitudInfoModal'
import { useGetSolAutorizacionByExp } from '@graphql/api/GetSolAutorizacionByExpediente'
